...
public final class ActivityAddPatientBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialButton btnSavePatient;
  ...
  private ActivityAddPatientBinding(@NonNull CoordinatorLayout rootView,
      @NonNull AppBarLayout appBarLayout, @NonNull MaterialButton btnSavePatient,
      @NonNull TextInputEditText etAge, @NonNull TextInputEditText etPatientName,
  ...
  public static ActivityAddPatientBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      MaterialButton btnSavePatient = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityAddPatientBinding((CoordinatorLayout) rootView, appBarLayout,
          btnSavePatient, etAge, etPatientName, etPhone, progressBar, toolbar);
    }
